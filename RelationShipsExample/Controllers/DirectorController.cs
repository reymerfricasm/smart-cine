...
namespace RelationShipsExample.Controllers
{
    public class DirectorController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "DirectorId,Name,LastName")] Director director)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "DirectorId,Name,LastName")] Director director)
        {
            if (ModelState.IsValid)
            {
